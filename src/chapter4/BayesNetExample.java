...
public class BayesNetExample {
    ...
    public BayesNetExample() {
        ...
        System.out.println("The probability of surgery being positive and the patient is younger than 55: " + belief);
        ...
        belief = BayesNetHelper.getBelief(inferenceGraph, surgical);
        System.out.println("The probability of surgery being positive for a smoker, younger than 55 with symptoms for more than 2 years: " + belief);
    }
